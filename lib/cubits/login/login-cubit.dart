...
//         // Handle error cases
//         final errorMessage = response['message'] ?? 'loginFailed'.tr();
//         emit(state.copyWith(
//           isLoading: false,
...
//       emit(state.copyWith(
//         isLoading: false,
//         errorMessage: 'serverResponseFormat'.tr(),
//       ));
//     } catch (e) {
//       print('Login error: $e');
//       String errorMessage = 'loginFailed'.tr();
//       if (e is FormatException) {
//         errorMessage = 'serverInvalidResponse'.tr();
